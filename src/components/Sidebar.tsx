...
const Sidebar: React.FC<SidebarProps> = ({ navigate, location, colors, SettingsIcon }) => {
  ...
  const iconActive = colors.accentText;
  return (
    <div className={`w-16 ${colors.container} ${colors.border} border-r flex flex-col items-center py-4 fixed top-0 left-0 h-full z-40`}>
      <div className="space-y-4 w-full flex-1">
        <button
          ...
          className={`p-3 rounded-lg transition-colors duration-200 mx-auto block ${location.pathname === '/home' ? `${accentBg} ${colors.buttonText}` : `${colors.buttonText} opacity-70 hover:opacity-100 ${accentBgHover}`}`}
          title="Home"
        >
        ...
        <button
          ...
          className={`p-3 rounded-lg transition-colors duration-200 mx-auto block ${location.pathname === '/calendar' ? `${accentBg} ${colors.buttonText}` : `${colors.buttonText} opacity-70 hover:opacity-100 ${accentBgHover}`}`}
          title="Calendar"
        >
        ...
        <button
          ...
          className={`p-3 rounded-lg transition-colors duration-200 mx-auto block ${location.pathname === '/markbook' ? `${accentBg} ${colors.buttonText}` : `${colors.buttonText} opacity-70 hover:opacity-100 ${accentBgHover}`}`}
          title="Markbook"
        >
        ...
        <button
          ...
          className={`p-3 rounded-lg transition-colors duration-200 mx-auto block ${location.pathname === '/settings' ? `${accentBg} ${colors.buttonText}` : `${colors.buttonText} opacity-70 hover:opacity-100 ${accentBgHover}`}`}
          title="Settings"
        >
